...
import (
	...
	cachev1alpha1 "github.com/kagamashi/azure-controller-PoC/api/v1alpha1"
	"github.com/kagamashi/azure-controller-PoC/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "ddd0683e.example.com",
